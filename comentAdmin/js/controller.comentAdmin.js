...
var access_forbidden = function (){
	...
	$window.location = '/desarrollo/login/'
}

var url = function (){ store.set('url', $location.absUrl());}

$scope.goLogin = function(){ url(); $window.location = '/desarrollo/login/'; }
$scope.goLogout = function(){ url(); $window.location = '/desarrollo/login/logout.php'; }
