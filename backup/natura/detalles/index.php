				...
				<div class=" large-12 columns">
					<div class="callout large" >
						...
						<div class="row small-up-1 medium-up-1 large-up-2">
							<div class="column">
								<div class="callout ">
									<div class="row"><img src="img/casas1.jpg"></div>
									<div id="img_separator" class="row"></div>
									<div class="row"><img src="img/casas2.jpg"></div>
								</div>
							</div>
							<div class="column">
							<div class="p">
							...
							<div class="foot">
								<a href="../galeria/#casas"><img src="img/verfotos.png"></a>
								<span>¡REALICE SU RESERVA! <a href="../index.php#contacto" class="more_button button">INGRESAR</a></span>
							</div>
							</div>
						</div>
					</div>
				...
				<div class=" large-12 columns">
					<div class="callout large" >
						...
						<div class="row small-up-1 medium-up-1 large-up-2">
							<div class="column">
								<div class="callout ">
									<div class="row"><img src="img/apartamento1.jpg"></div>
									<div id="img_separator" class="row"></div>
									<div class="row"><img src="img/apartamento2.jpg"></div>
								</div>
							</div>
							<div class="column">
							<div class="p">
							...
							<div class="foot">
								<a href="../galeria/#apartamentos"><img src="img/verfotos.png"></a>
								<span>¡REALICE SU RESERVA! <a href="../index.php#contacto" class="more_button button">INGRESAR</a></span>
							</div>
							</div>
						</div>
				...
				<div class=" large-12 columns">
					<div class="callout large" >
						...
						<div class="row small-up-1 medium-up-1 large-up-2">
							<div class="column">
								<div class="callout ">
									<div class="row"><img src="img/villa1.jpg"></div>
									<div id="img_separator" class="row"></div>
									<div class="row"><img src="img/villa2.jpg"></div>
								</div>
							</div>
							<div class="column">
							<div class="p">
							...
							<div class="foot">
								<a href="../galeria/#villas"><img src="img/verfotos.png"></a>
								<span>¡REALICE SU RESERVA! <a href="../index.php#contacto" class="more_button button">INGRESAR</a></span>
							</div>
							</div>
						</div>
				...
				<div class=" large-12 columns">
					<div class="callout large" >
						...
						<div class="row small-up-1 medium-up-1 large-up-2">
							<div class="column">
								<div class="callout ">
									<div class="row"><img src="img/apartaestudio1.jpg"></div>
									<div id="img_separator" class="row"></div>
									<div class="row"><img src="img/apartaestudio2.jpg"></div>
								</div>
							</div>
							<div class="column">
							<div class="p">
							...
							<div class="foot">
								<a href="../galeria/#apartaestudios"><img src="img/verfotos.png"></a>
								<span>¡REALICE SU RESERVA! <a href="../index.php#contacto" class="more_button button">INGRESAR</a></span>
							</div>
							</div>
						</div>
