...
if (isset($tpl['status']))
{
	...
	<fieldset class="fieldset white">
		...
		<form action="<?php echo PJ_INSTALL_URL; ?>bookAdmin.php?controller=pjLocale&amp;action=pjActionImportConfirm" method="post" class="form pj-form" enctype="multipart/form-data">
	...
	<fieldset class="fieldset white">
		...
		<form action="<?php echo PJ_INSTALL_URL; ?>bookAdmin.php?controller=pjLocale&amp;action=pjActionExport" method="post" class="form pj-form">
