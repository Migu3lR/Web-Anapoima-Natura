...
if (isset($tpl['status']))
{
	...
	?>
	<form action="<?php echo PJ_INSTALL_URL; ?>bookAdmin.php?controller=pjInvoice&amp;action=pjActionIndex" id="frmInvoiceConfig" method="post" class="pj-form form" enctype="multipart/form-data">
