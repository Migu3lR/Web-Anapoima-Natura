<div class="col-md-12 col-md-offset-1">
	...
	if (isset($tpl['status']) && $tpl['status'] == 'OK')
	{
		?>
		<br>
		<form action="" class="form-horizontal stivaFormCheckOut hbSelectorFormCheckout" data-toggle="validator" role="form" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" name="c_fname" value="<?php echo pjSanitize::html(@$FORM['c_fname']) == NULL ? $_SESSION['nombre'] : pjSanitize::html(@$FORM['c_fname']); ?>"<?php echo (int) $tpl['option_arr']['o_bf_fname'] === 3 ? ' required' : NULL; ?> data-msg-required="<?php __('front_validate_fname', false, true); ?>">
				</div><!-- /.col-sm-10 -->
			</div>
			<?php endif; ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" name="c_lname" value="<?php echo pjSanitize::html(@$FORM['c_lname'])== NULL ? $_SESSION['apellido'] : pjSanitize::html(@$FORM['c_lname']); ?>"<?php echo (int) $tpl['option_arr']['o_bf_lname'] === 3 ? ' required' : NULL; ?> data-msg-required="<?php __('front_validate_lname', false, true); ?>">
				</div><!-- /.col-sm-10 -->
			</div>
			<?php endif; ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" name="c_phone" value="<?php echo pjSanitize::html(@$FORM['c_phone'])== NULL ? $_SESSION['telefono'] : pjSanitize::html(@$FORM['c_phone']); ?>"<?php echo (int) $tpl['option_arr']['o_bf_phone'] === 3 ? ' required' : NULL; ?> data-msg-required="<?php __('front_validate_phone', false, true); ?>">
				</div><!-- /.col-sm-10 -->
			</div>
			<?php endif; ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="email" class="form-control" name="c_email" value="<?php echo pjSanitize::html(@$FORM['c_email'])== NULL ? $_SESSION['correo'] : pjSanitize::html(@$FORM['c_email']); ?>"<?php echo (int) $tpl['option_arr']['o_bf_email'] === 3 ? ' required' : NULL; ?> data-msg-required="<?php __('front_validate_email', false, true); ?>" data-msg-email="<?php __('front_validate_email_invalid', false, true); ?>">
				</div><!-- /.col-sm-10 -->
			</div>
			<?php endif; ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="row">
						<div class="col-sm-3">
							<div class="input-group bootstrap-timepicker stivaTimePicker">
								<input type="text" class="form-control" name="c_arrival" value="<?php echo pjSanitize::html(@$FORM['c_arrival']); ?>"<?php echo (int) $tpl['option_arr']['o_bf_arrival'] === 3 ? ' required' : NULL; ?> data-msg-required="<?php __('front_validate_arrival', false, true); ?>">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" name="c_city" value="<?php echo pjSanitize::html(@$FORM['c_city'])== NULL ? $_SESSION['ciudad'] : pjSanitize::html(@$FORM['c_city']); ?>"<?php echo (int) $tpl['option_arr']['o_bf_city'] === 3 ? ' required' : NULL; ?> data-msg-required="<?php __('front_validate_city', false, true); ?>">
				</div><!-- /.col-sm-10 -->
			</div>
			<?php endif; ?>
			...
			<hr>
			<br>
			<h3 class="stivaFormCheckOutTitle"><?php __('front_human_verification'); ?></h3>
			<br>
			<div class="form-group">
				<label class="col-sm-3 control-label"><?php __('front_captcha'); ?><?php if ((int) $tpl['option_arr']['o_bf_captcha'] === 3) : ?> <span class="text-danger">*</span><?php endif; ?></label>
				
				<div class="col-sm-9">
					<div class="row">
						<div class="col-sm-3">
							<input type="text" class="form-control" name="captcha" maxlength="6" autocomplete="off"<?php echo (int) $tpl['option_arr']['o_bf_captcha'] === 3 ? ' required' : NULL; ?> data-msg-required="<?php __('front_validate_captcha', false, true); ?>" data-msg-remote="<?php __('front_validate_captcha_remote', false, true); ?>">
						</div><!-- /.col-sm-2 -->
						
						<div class="col-sm-3">
							<img src="<?php echo PJ_INSTALL_URL; ?>bookAdmin.php?controller=pjFront&action=pjActionCaptcha&amp;rand=<?php echo rand(1, 999999); ?>" alt="Captcha">
						</div><!-- /.col-sm-2 -->
					</div><!-- /.row -->
				</div><!-- /.col-sm-10 -->
			</div>
			...
			<hr>
			<br>
			<h3><?php __('front_terms'); ?></h3>
			<br>
			<div class="form-group">
				<label class="col-sm-3 control-label"><?php __('front_terms_label'); ?><?php if ((int) $tpl['option_arr']['o_bf_terms'] === 3) : ?> <span class="text-danger">*</span><?php endif; ?></label>
				
				<div class="col-sm-9">
					<div>
						<input type="checkbox" name="terms" value="1"<?php echo (int) $tpl['option_arr']['o_bf_terms'] === 3 ? ' required' : NULL; ?> data-msg-required="<?php __('front_validate_terms', false, true); ?>"> <?php __('front_terms_note'); ?>
						<?php
						...
						if (!empty($t_url) && preg_match('/^http(s)?:\/\//i', $t_url))
						{
							...
							?>
							<p><a data-toggle="modal" href="<?php echo PJ_INSTALL_URL; ?>bookAdmin.php?controller=pjFront&action=pjActionGetTerms&cid=<?php echo @$_GET['cid']; ?>" data-target="#myModal_<?php echo @$_GET['cid']; ?>"><?php __('front_terms_link'); ?></a></p>
							<?php
						} 
						?>
					</div>
