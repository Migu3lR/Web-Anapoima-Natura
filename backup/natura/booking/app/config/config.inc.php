...
if (!defined("PJ_DB")) define("PJ_DB", "natura");
if (!defined("PJ_PREFIX")) define("PJ_PREFIX", "bk_");
if (!defined("PJ_INSTALL_FOLDER")) define("PJ_INSTALL_FOLDER", "/booking/");
if (!defined("PJ_INSTALL_PATH")) define("PJ_INSTALL_PATH", "C:/wamp/www/booking/");
if (!defined("PJ_INSTALL_URL")) define("PJ_INSTALL_URL", "/natura/booking/");
