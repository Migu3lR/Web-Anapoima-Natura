...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '1', 'title', 'No extras found.<br>Click <a href="bookAdmin.php?controller=pjAdminExtras&amp;action=pjActionCreate">here</a> and follow the instructions to add an extra.', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '2', 'title', 'No extras found.<br>Click <a href="bookAdmin.php?controller=pjAdminExtras&amp;action=pjActionCreate">here</a> and follow the instructions to add an extra.', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '3', 'title', 'No extras found.<br>Click <a href="bookAdmin.php?controller=pjAdminExtras&amp;action=pjActionCreate">here</a> and follow the instructions to add an extra.', 'script');
