...
<div class="i-wrap">
	...
	<div class="t20">
		...
		<form action="bookAdmin.php?controller=pjInstaller&amp;action=pjActionStep7&amp;install=1" method="post" id="frmStep6" class="i-form float_right">
			<input type="hidden" name="step6" value="1" />
			<input type="button" tabindex="2" value="&laquo; Back" class="pj-button" onclick="window.location='bookAdmin.php?controller=pjInstaller&amp;action=pjActionStep5'" />
