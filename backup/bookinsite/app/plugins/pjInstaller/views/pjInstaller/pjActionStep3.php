...
<div class="i-wrap">
	...
	<form action="bookAdmin.php?controller=pjInstaller&amp;action=pjActionStep4&amp;install=1" method="post" id="frmStep3" class="i-form">
		...
		<div class="t20">
			...
			<input type="button" tabindex="5" value="&laquo; Back" class="pj-button float_right" onclick="window.location='bookAdmin.php?controller=pjInstaller&amp;action=pjActionStep2'" />
			<br class="clear_both" />
		</div>
	</form>
