...
if (isset($tpl['status']))
{
	...
	<form action="<?php echo PJ_INSTALL_URL; ?>bookAdmin.php?controller=pjInvoice&amp;action=pjActionUpdate" method="post" class="pj-form form" id="frmUpdateInvoice">
		...
		<div id="tabs">
			<ul>
				...
				<li class="plugin_view_invoice"><a href="<?php echo PJ_INSTALL_URL; ?>?controller=pjInvoice&amp;action=pjActionView&amp;uuid=<?php echo $tpl['arr']['uuid']; ?>" target="_blank"><?php __('plugin_invoice_i_invoice'); ?></a></li>
			</ul>
			<div id="tabs-1">
	...
	<form action="<?php echo PJ_INSTALL_URL; ?>bookAdmin.php" method="get" target="_blank" style="display: none" id="frmPluginInvoicePrint">
	...
	<form action="<?php echo PJ_INSTALL_URL; ?>bookAdmin.php" method="get" target="_blank" style="display: none" id="frmPluginInvoiceView">
		<input type="hidden" name="controller" value="pjInvoice" />
