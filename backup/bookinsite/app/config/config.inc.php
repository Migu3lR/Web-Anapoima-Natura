...
if (!defined("PJ_INSTALL_FOLDER")) define("PJ_INSTALL_FOLDER", "/bookinsite/");
if (!defined("PJ_INSTALL_PATH")) define("PJ_INSTALL_PATH", "/bookinsite/");
if (!defined("PJ_INSTALL_URL")) define("PJ_INSTALL_URL", "/bookinsite/");
