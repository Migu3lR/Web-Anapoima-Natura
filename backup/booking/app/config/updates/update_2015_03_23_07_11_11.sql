...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '1', 'title', 'You need to have at least one room type added before you can see availability calendar. Click <a href="index.php?controller=pjAdminRooms&action=pjActionCreate">here</a> and follow the instructions to add a new room type.', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '2', 'title', 'You need to have at least one room type added before you can see availability calendar. Click <a href="index.php?controller=pjAdminRooms&action=pjActionCreate">here</a> and follow the instructions to add a new room type.', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '3', 'title', 'You need to have at least one room type added before you can see availability calendar. Click <a href="index.php?controller=pjAdminRooms&action=pjActionCreate">here</a> and follow the instructions to add a new room type.', 'script');
