...
<html>
	<head>
		...
		<link href="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjFront&action=pjActionLoadCss&cid=<?php echo @$_GET['cid']; ?><?php echo isset($_GET['theme']) && strlen($_GET['theme']) > 0 ? '&theme=' . (int) $_GET['theme'] : NULL; ?>" type="text/css" rel="stylesheet" />
	</head>
	<body>
		<script type="text/javascript" src="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjFront&action=pjActionLoad&cid=<?php echo @$_GET['cid']; ?><?php echo isset($_GET['theme']) && strlen($_GET['theme']) > 0 ? '&theme=' . (int) $_GET['theme'] : NULL; ?>"></script>
	</body>
</html>
	<?php 
} else {
