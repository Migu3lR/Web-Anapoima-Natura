...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '1', 'title', 'If you need help setting up your Hotel Booking Software do not hesitate to <a href="bookAdmin.php?controller=pjAdmin&action=pjActionSupport">contact us</a>.', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '2', 'title', 'If you need help setting up your Hotel Booking Software do not hesitate to <a href="bookAdmin.php?controller=pjAdmin&action=pjActionSupport">contact us</a>.', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '3', 'title', 'If you need help setting up your Hotel Booking Software do not hesitate to <a href="bookAdmin.php?controller=pjAdmin&action=pjActionSupport">contact us</a>.', 'script');
