...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '1', 'title', 'Click on the thumbnail below to see available color themes. To put the booking engine on your website go to <a href="bookAdmin.php?controller=pjAdminOptions&action=pjActionInstall">Install</a> page.', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '2', 'title', 'Click on the thumbnail below to see available color themes. To put the booking engine on your website go to <a href="bookAdmin.php?controller=pjAdminOptions&action=pjActionInstall">Install</a> page.', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '3', 'title', 'Click on the thumbnail below to see available color themes. To put the booking engine on your website go to <a href="bookAdmin.php?controller=pjAdminOptions&action=pjActionInstall">Install</a> page.', 'script');
