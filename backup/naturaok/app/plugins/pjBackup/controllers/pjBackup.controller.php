...
class pjBackup extends pjBackupAppController
{
	...
	public function pjActionIndex()
	{
		...
		if (isset($_POST['backup']))
		{
			...
			{
				pjUtil::redirect(PJ_INSTALL_URL . "bookAdmin.php?controller=pjBackup&action=pjActionIndex&err=PBU05");
			}
			
			if (!is_writable($backup_folder))
			{
				pjUtil::redirect(PJ_INSTALL_URL . "bookAdmin.php?controller=pjBackup&action=pjActionIndex&err=PBU06");
			}
			...
			pjUtil::redirect(sprintf("%sbookAdmin.php?controller=pjBackup&action=pjActionIndex&err=%s", PJ_INSTALL_URL, $err));
		}
