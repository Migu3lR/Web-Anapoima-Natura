...
<div class="i-wrap">
	...
	<form action="bookAdmin.php?controller=pjInstaller&amp;action=pjActionStep3&amp;install=1" method="post" id="frmStep2" class="i-form">
		...
		<div class="t20">
			...
			<input type="button" tabindex="7" value="&laquo; Back" class="pj-button float_right" onclick="window.location='bookAdmin.php?controller=pjInstaller&amp;action=pjActionStep1'" />
			<br class="clear_both" />
		</div>
	</form>
</div>