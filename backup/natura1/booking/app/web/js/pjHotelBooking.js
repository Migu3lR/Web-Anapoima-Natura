	...
	HotelBooking.prototype = {
		...
		init: function (opts) {
			...
			this.$container.on("click.hb", ".hbSelectorLocale", function (e) {
				...
				self.disableButtons.call(self);
				pjQ.$.get([self.opts.folder, "index.php?controller=pjFront&action=pjActionGetRoom"].join(""), {
					"cid": self.opts.cid,
					"room_id": room_id,
					"cnt": cnt,
					"adults": 1,
				...
				self.disableButtons.call(self);
				pjQ.$.get([self.opts.folder, "index.php?controller=pjFront&action=pjActionGetPrice"].join(""), {
					"cid": self.opts.cid,
				...
				self.disableButtons.call(self);
				pjQ.$.post([self.opts.folder, "index.php?controller=pjFront&action=pjActionSetPrice&cid=", self.opts.cid].join(""), $form.serialize()).done(function (data) {
					if (data.status == "OK") {
						pjQ.$.get([self.opts.folder, "index.php?controller=pjFront&action=pjActionGetRoom"].join(""), {
							"cid": self.opts.cid,
				...
				self.disableButtons.call(self);
				pjQ.$.get([self.opts.folder, "index.php?controller=pjFront&action=pjActionRemoveCode&cid=", self.opts.cid].join("")).done(function (data) {
					self.loadExtras.call(self);
				}).fail(function () {
					self.enableButtons.call(self);
				});
		...
		getAdultsChildren: function (callback) {
			var self = this;
			pjQ.$.get([this.opts.folder, "index.php?controller=pjFront&action=pjActionGetAdultsChildren&cid=", this.opts.cid].join("")).done(function (data) {
		...
		handleExtras: function (el) {
			var $el = pjQ.$(el);
			var jqXhr = pjQ.$.post([this.opts.folder, "index.php?controller=pjFront&action=pjActionHandleExtras&cid=", this.opts.cid].join(""), {
				extra_id: $el.val(),
		...
		loadSearch: function () {
			var self = this;
			pjQ.$.get([this.opts.folder, "index.php?controller=pjFrontPublic&action=pjActionSearch"].join(""), {
				"cid": this.opts.cid,
		...
		loadRooms: function () {
			...
			var self = this;
			pjQ.$.get([this.opts.folder, "index.php?controller=pjFrontPublic&action=pjActionRooms"].join(""), {
				"cid": this.opts.cid,
				"locale": this.opts.locale,
				"hide": this.opts.hide,
				"theme": this.opts.theme,
		...
		bindValidationVoucher: function (callback) {
			...
			if (validate) {
				self.$container.find(".hbSelectorVoucherForm").on("keyup.hb", 'input[name="code"]', function (e) {
					...
					submitHandler: function (form) {
						self.disableButtons.call(self);
						pjQ.$.post([self.opts.folder, "index.php?controller=pjFront&action=pjActionApplyCode&cid=", self.opts.cid].join(""), pjQ.$(form).serialize()).done(function (data) {
		...
		loadExtras: function () {
			...
			var self = this;
			pjQ.$.get([this.opts.folder, "index.php?controller=pjFrontPublic&action=pjActionExtras"].join(""), {
				"cid": this.opts.cid,
				"locale": this.opts.locale,
				"hide": this.opts.hide,
				"theme": this.opts.theme
		...
		loadCheckout: function () {
			...
			var self = this;
			pjQ.$.get([this.opts.folder, "index.php?controller=pjFrontPublic&action=pjActionCheckout"].join(""), {
				"cid": this.opts.cid,
				"locale": this.opts.locale,
				"hide": this.opts.hide,
				"theme": this.opts.theme
				...
				if (validate) {
					self.$container.find("form.hbSelectorFormCheckout").validate({
						...
						submitHandler: function (form) {
							self.disableButtons.call(self);
							pjQ.$.post([self.opts.folder, "index.php?controller=pjFrontPublic&action=pjActionCheckout&cid=", self.opts.cid,
		...
		loadPreview: function () {
			...
			var self = this;
			pjQ.$.get([this.opts.folder, "index.php?controller=pjFrontPublic&action=pjActionPreview"].join(""), {
				"cid": this.opts.cid,
				"locale": this.opts.locale,
				"hide": this.opts.hide,
				"theme": this.opts.theme
				...
				if (validate) {
					self.$container.find("form").validate({
						submitHandler: function (form) {
							self.disableButtons.call(self);
							pjQ.$.post([self.opts.folder, "index.php?controller=pjFront&action=pjActionProcessOrder&cid=", self.opts.cid].join(""), pjQ.$(form).serialize()).done(function (data) {
								if (data.status == "OK") {
		...
		loadBooking: function () {
			...
			var self = this;
			pjQ.$.get([this.opts.folder, "index.php?controller=pjFrontPublic&action=pjActionBooking"].join(""), {
				"cid": this.opts.cid,
				"locale": this.opts.locale,
				"hide": this.opts.hide,
				"theme": this.opts.theme,
