...
&lt;script type="text/javascript" src="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjFront&action=pjActionLoad&cid=<?php echo $controller->getForeignId(); ?>&theme=<?php echo $tpl['option_arr']['o_theme']; ?>"&gt;&lt;/script&gt;</textarea>
	...
	<div style="display:none" id="hidden_code">&lt;link href="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjFront&action=pjActionLoadCss&cid=<?php echo $controller->getForeignId(); ?>" type="text/css" rel="stylesheet" /&gt;
&lt;script type="text/javascript" src="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjFront&action=pjActionLoad&cid=<?php echo $controller->getForeignId(); ?>"&gt;&lt;/script&gt;</div>
