					...
					<div class="callout small">
						<div class="accordion"> 
							...
							<div class="acc_content">
								...
								<h5><strong><a href="../detalles/#casas">Amplias y fascinantes casas familiares de 300 m<span class="super">2</span> (área privada)</a></strong></h5>
								...
								<div class="acc_bottom">
									...
									<a href="../galeria/#casas"><img id="link" src="img/verfotos.png"></a>
								</div>
								</div>
							...
							<div class="acc_content">
								...
								<div class="acc_content_left">
								<h5><strong><a href="../detalles/#apartamentos">Cómodos y acogedores apartamentos de 120 m<span class="super">2</span></a></strong></h5>
								...
								<div class="acc_bottom">
									...
									<a href="../galeria/#apartamentos"><img id="link" src="img/verfotos.png"></a>
								</div>
								</div>
								<div class="acc_content_right">
							...
							<div class="acc_content">
								...
								<div class="acc_content_left">
								<h5><strong><a href="../detalles/#villas">Confortables y sofisticadas Villas de 110 m<span class="super">2</span></a></strong></h5>
								...
								<div class="acc_bottom">
									...
									<a href="../galeria/#villas"><img id="link" src="img/verfotos.png"></a>
								</div>
								</div>
								<div class="acc_content_right">
							...
							<div class="acc_content">
								<div class="acc_content_left">
								<h5><strong><a href="../detalles/#apartaestudios">Amplios y modernos apartaestudios de 45 m<span class="super">2</span></a></strong></h5>
								<ul>
								<li>Cocina integral</li>
								<li>Barra comedor</li>
								<li>Sala de estar</li>
								...
								<div class="acc_bottom">
									...
									<a href="../galeria/#apartaestudios"><img id="link" src="img/verfotos.png"></a>
								</div>
								</div>
								<div class="acc_content_right">
							...
							<p><strong>Natura ha sido creado exclusivamente para el disfrute de sus huéspedes, por lo tanto tenga en cuenta las siguientes recomendaciones:</strong></p>
								...
								<div class="acc_bottom">
									...
									<a href="#" class="more_button button">Ver todas las Condiciones Generales</a></p>
								</div>
								</div>
								<div class="acc_content_right">
