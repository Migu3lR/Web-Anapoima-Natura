...
<!-- Fuente de texto del sitio -->
	...
	<script src="../js/angular-storage.js"></script> <!-- Libreria para manejo de storage web -->
	<script src="../js/cookies.js"></script> <!-- Libreria para manejo de cookies -->
