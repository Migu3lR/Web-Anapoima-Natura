...
<body ng-controller="control" ng-cloak>
	<?php $_GET['section']='header'; require('../layout.php'); ?> <!-- Se invoca plantilla del Header --> 
...
<script src="../js/vendor/what-input.min.js"></script> <!-- Necesario para Foundation (Multiplataforma) -->
<script src="../js/Foundation.js"></script> <!-- Core de Foundation para el diseño -->
