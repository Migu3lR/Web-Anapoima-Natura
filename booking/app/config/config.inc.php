...
if (!defined("PJ_DB")) define("PJ_DB", "naturabase_desarrollo");
if (!defined("PJ_PREFIX")) define("PJ_PREFIX", "bk_");
if (!defined("PJ_INSTALL_FOLDER")) define("PJ_INSTALL_FOLDER", "/desarrollo/booking/");
if (!defined("PJ_INSTALL_PATH")) define("PJ_INSTALL_PATH", "C:/wamp/www/desarrollo/booking/");
if (!defined("PJ_INSTALL_URL")) define("PJ_INSTALL_URL", "http://localhost/desarrollo/booking/");
if (!defined("PJ_SALT")) define("PJ_SALT", "Z9L7N5H3");
