...
if (!$stop)
{
	...
	{
		header("Location: bookAdmin.php?controller=pjInstaller&action=pjActionStep1&install=1");
		exit;
	}
}
...
if (!defined("PJ_GALLERY_SMALL")) define("PJ_GALLERY_SMALL", "106,80");
if (!defined("PJ_GALLERY_MEDIUM")) define("PJ_GALLERY_MEDIUM", "320,240");
...
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "70");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "3.2.0");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "hotel_booking_");
if (!defined("PJ_TEST_MODE")) define("PJ_TEST_MODE", false);
if (!defined("PJ_DISABLE_MYSQL_CHECK")) define("PJ_DISABLE_MYSQL_CHECK", false);

if (!defined("PJ_INVOICE_PLUGIN")) define("PJ_INVOICE_PLUGIN", 'bookAdmin.php?controller=pjAdminBookings&action=pjActionUpdate&uuid={ORDER_ID}');
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjBackup', 'pjLog', 'pjInstaller', 'pjOneAdmin',  'pjAuthorize', 'pjPaypal', 'pjInvoice', 'pjGallery', 'pjSms', 'pjPrice', 'pjCountry');
?>