	...
	$(function () {
		...
		if ($("#grid").length > 0 && datagrid) {
			...
			var gridOpts = {
				...
				dataUrl: "bookAdmin.php?controller=pjSms&action=pjActionGetSms" + pjGrid.queryString,
				dataType: "json",
			...
			$(document).on("submit", ".frm-filter", function (e) {
				...
				$grid.datagrid("load", "bookAdmin.php?controller=pjSms&action=pjActionGetSms", "id", "ASC", content.page, content.rowCount);
				return false;
			});
		}
