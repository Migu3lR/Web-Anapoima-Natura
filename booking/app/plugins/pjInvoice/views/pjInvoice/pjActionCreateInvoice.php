...
if (isset($tpl['status']))
{
	...
	<form action="<?php echo PJ_INSTALL_URL; ?>bookAdmin.php?controller=pjInvoice&amp;action=pjActionCreateInvoice" method="post" class="pj-form form" id="frmCreateInvoice">
