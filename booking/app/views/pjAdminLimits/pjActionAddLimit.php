...
<form action="" method="post" class="pj-form form">
	...
	<p>
		...
		<span class="pj-form-field-custom pj-form-field-custom-after">
			<input type="text" name="date_to" id="al_date_to" class="pj-form-field pointer w80 datepick required" data-msg-required="<?php __('lblFieldRequired');?>" readonly="readonly" rel="<?php echo $week_start; ?>" rev="<?php echo $jqDateFormat; ?>" data-months="<?php echo join(',', $months);?>" data-shortmonths="<?php echo join(',', $short_months);?>" data-day="<?php echo join(',', $days);?>" data-daymin="<?php echo join(',', $short_days);?>"/>
			<span class="pj-form-field-after"><abbr class="pj-form-field-icon-date"></abbr></span>
		</span>
	</p>
	<p>
	...
	<p>
		...
		<span class="inline_block">
			<input type="text" name="min_nights" id="al_min_nights" class="pj-form-field w80" readonly="readonly" />
		</span>
	</p>
	<p>
		<label class="title"><?php __('limit_max_nights'); ?></label>
		<span class="inline_block">
			<input type="text" name="max_nights" id="al_max_nights" class="pj-form-field w80" readonly="readonly" />
		</span>
	</p>
</form>