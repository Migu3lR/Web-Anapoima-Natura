<table class="tblReport" cellpadding="0" cellspacing="0" style="width: 100%;">
	...
	<tr>
		...
		<td colspan="3" class="content-cell"><label><span><?php echo (int) @$tpl['cancelled_arr']['bookings'];?></span><abbr><?php @$tpl['cancelled_arr']['nights'] != 1 ? __('report_nights') : __('report_night'); ?></abbr></label></td>
