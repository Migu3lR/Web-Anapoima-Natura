...
&lt;script type="text/javascript" src="<?php echo PJ_INSTALL_URL; ?>bookAdmin.php?controller=pjFront&action=pjActionLoad&cid=<?php echo $controller->getForeignId(); ?>&theme=<?php echo $tpl['option_arr']['o_theme']; ?>"&gt;&lt;/script&gt;</textarea>
		...
		<div class="install-method">
			...
			<div class="install-code">
		 		<a target="_blank" href="<?php echo PJ_INSTALL_URL; ?>index.php"><?php echo PJ_INSTALL_URL; ?>index.php</a>
			</div>
		</div>
		...
		<div class="install-method">
			...
			<div class="install-code">
				<textarea class="pj-form-field textarea_install" style="overflow: auto; height:65px">&lt;a href="<?php echo PJ_INSTALL_URL; ?>index.php"&gt;<?php __('install_link'); ?>&lt/a&gt;</textarea>
			</div>
		</div>
	</div>
